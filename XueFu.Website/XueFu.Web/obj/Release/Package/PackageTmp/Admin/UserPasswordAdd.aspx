<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="UserPasswordAdd.aspx.cs" Inherits="XueFu.Web.Admin.UserPasswordAdd" %>
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
<div class="position"><img src="images/PositionIcon.png"  alt=""/>修改密码</div>
<div class="add">
	<ul>
		<li class="left">登陆名：</li>
		<li class="right"><asp:TextBox CssClass="input" Width="300px" ID="Name" runat="server" Enabled="false"></asp:TextBox><asp:RequiredFieldValidator
                ID="RequiredFieldValidator1" runat="server" ErrorMessage="改密码登陆名怎么能为空呢？" ControlToValidate="Name" Display="Dynamic"></asp:RequiredFieldValidator></li>
	</ul>
	<ul>
	...
	<ul>
		...
		<li class="right"><asp:TextBox CssClass="input" Width="300px" ID="NewPassword2" runat="server" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationExpression="^[\W\w]{6,16}$" ErrorMessage="密码长度大于6位少于16位" Display="Dynamic" ControlToValidate="NewPassword"></asp:RegularExpressionValidator><asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="两次密码不一致" ControlToCompare="NewPassword" ControlToValidate="NewPassword2" Display="Dynamic"></asp:CompareValidator>
        </li>
	</ul>
</div>
<div class="action">
