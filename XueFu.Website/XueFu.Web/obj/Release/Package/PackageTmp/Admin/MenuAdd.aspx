<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="MenuAdd.aspx.cs" Inherits="XueFu.Web.Admin.MenuAdd" %>
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
<div class="position"><img src="Images/PositionIcon.png"  alt=""/>菜单<%=GetAddUpdate()%></div>
<div class="add">
	<ul>
