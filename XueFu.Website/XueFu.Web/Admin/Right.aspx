<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="Right.aspx.cs" Inherits="XueFu.Web.Admin.Right"%>
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">	
<DIV class=position><IMG alt="" src="images/PositionIcon.png">系统桌面</DIV>
<DIV class=rightBlock>
    <DIV class=rightLeft>
        <div class="boldTitle">待处理事务</div>
        <ul class="add">
            <li><span class="left">产品</span> 未处理课程评论 <a href="ProductComment.aspx?Action=search&Status=1" class="red">  </a> 条；未处理的缺货登记 <a href="BookingProduct.aspx?Action=search&IsHandler=0" class="red">  </a> 条</li>
            <li><span class="left">用户</span> 未激活用户<a href="User.aspx?Action=search&Status=1" class="red">  </a> 位； 冻结用户 <a href="User.aspx?Action=search&Status=3" class="red">  </a> 位； 未处理的用户留言 <a href="UserMessage.aspx?Action=search&IsHandler=0" class="red"></a> 条； <%--未处理的提现申请<a href="UserApply.aspx?Action=search&Status=1" class="red"> <%=dt.Rows[0][5]%> </a> 条--%></li>	        
            <li><span class="left">订单</span> 待付款订单 <a href="Order.aspx?OrderStatus=1" class="red"> </a> 个；待审核订单 <a href="Order.aspx?OrderStatus=2" class="red"> </a> 个；待发货订单 <a href="Order.aspx?OrderStatus=4" class="red">  </a> 个；待收货确认订单 <a href="Order.aspx?OrderStatus=5" class="red">  </a> 个</li>
        </ul>
