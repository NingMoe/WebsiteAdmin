...
namespace XueFu.Web.Admin
{
    public class AdminBasePage : Page
    {
        ...
        /// <returns></returns>
        public bool CompareAdminPower(string powerString, PowerCheckType powerCheckType)
        {
            string power = AdminGroupBLL.ReadAdminGroupCache(Cookies.Admin.GetGroupID(false)).Power;
            bool flag = false;
            string powerKey = Config.ReadConfigInfo().PowerKey;
        ...
        {
            this.CheckAdminPower(Config.ReadConfigInfo().PowerKey, powerString, PowerCheckType.Single, ref this.AdminID);
        }
        ...
        private void CheckAdminPower(string powerKey, string powerString, PowerCheckType powerCheckType, ref int adminID)
        {
            ...
            if (adminID == -1)
            {
                ScriptHelper.Alert(Language.ReadLanguage("NoPower"));
            }
        }
