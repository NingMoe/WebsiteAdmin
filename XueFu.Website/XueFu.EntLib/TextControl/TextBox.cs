            ...
            if (((this.RequiredFieldType != null) && (this.RequiredFieldType != "")) && (this.RequiredFieldType != "暂无校验"))
            {
                ...
                switch (this.RequiredFieldType)
                {
                    ...
                    case "日期":
                        ...
                        this.requiredFieldTypeREV.ErrorMessage = "* 请输入正确的日期,如:2016-1-1";
                        break;
                    ...
                    case "日期时间":
                        ...
                        this.requiredFieldTypeREV.ErrorMessage = "* 请输入正确的日期时间,如: 2016-1-1 23:59:59 或者 2016-1-1";
                        break;
                    ...
                    case "邮编":
                        ...
                        this.requiredFieldTypeREV.ErrorMessage = "* 请输入正确的邮编";
                        break;
