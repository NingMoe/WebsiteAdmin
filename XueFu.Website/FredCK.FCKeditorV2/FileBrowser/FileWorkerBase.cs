            ...
            else
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            file.SaveAs(path);
                            ConfigInfo waterConfig = XueFu.Common.Config.ReadConfigInfo();
                            int waterType = waterConfig.WaterType;
                            int waterPossition = waterConfig.WaterPossition;
                            string text = waterConfig.Text;
                            string textFont = waterConfig.TextFont;
                            int textSize = waterConfig.TextSize;
                            string textColor = waterConfig.TextColor;
                            string waterImage = base.Server.MapPath(waterConfig.WaterPhoto);
                            switch (waterType)
                            {
                                case 2:
                                case 3:
