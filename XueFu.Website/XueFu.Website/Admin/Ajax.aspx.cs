    ...
    public partial class Ajax : System.Web.UI.Page
    {
        ...
        protected void Login()
        {
            ...
            if (info.ID > 0)
            {
                ...
                string str5 = FormsAuthentication.HashPasswordForStoringInConfigFile(info.ID.ToString() + info.Name + info.GroupID.ToString() + str4 + Config.ReadConfigInfo().SecureKey + ClientHelper.Agent, "MD5");
