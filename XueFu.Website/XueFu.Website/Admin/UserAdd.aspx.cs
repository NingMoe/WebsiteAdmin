    ...
    public partial class UserAdd : AdminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                State.DataSource = EnumHelper.ReadEnumList<UserState>();
                State.DataTextField = "ChineseName";
                State.DataValueField = "Value";
                State.DataBind();
                State.SelectedValue = ((int)UserState.NoCheck).ToString();

                GroupID.DataSource = EnumHelper.ReadEnumList<GroupType>();
                GroupID.DataTextField = "ChineseName";
